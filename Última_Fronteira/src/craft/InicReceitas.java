...
public class InicReceitas {
	...
	public ArrayList<Receita> inicializarReceitas(){
		...
		ArrayList<ClassItem> marretaIng = new ArrayList<>(Arrays.asList( //Mecânico *Exclusivo
			    craftaveis.get(3), //Graveto
			    craftaveis.get(4)  //Ferro Bruto
			));
		ArrayList<ClassItem> espadaDeBronzeIng = new ArrayList<>(Arrays.asList( //Mecânico 
			    craftaveis.get(3), //Graveto
